"""Build the Gate 2.5 replacement from the accepted device-green Gate 2.4 cart.

Feature gate remains Gate 2.5; published package/cart version is 0.2.6 because
failed 0.2.5 installs already exist and require a strictly newer updater version.
"""
