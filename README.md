# Gen 1 Recomp Mod Index

Comprehensive GenRecomp-compatible index for **FAFF0x/gen1recomp** mods, dependencies, optional integrations, conflicts, and author-hosted downloads.

## What this repository does

- Indexes every ZIP published in `FAFF0x/gen1recomp`.
...
The Android Performance Monitor package is preserved as an alternate build under the same manifest ID rather than inventing a duplicate mod ID.

## Import URLs

After Pages is enabled:

- Repository slug: `DuskPromised/gen1recomp-mod-index`
- Feed: `https://duskpromised.github.io/gen1recomp-mod-index/data/index.json`
- Catalog: `https://duskpromised.github.io/gen1recomp-mod-index/`

Source collection: https://github.com/FAFF0x/gen1recomp
