...
A curated Pokémon Red cart combining voxel battles, all 151 obtainable in one save, a boy/girl avatar choice, refined widescreen menus, shiny Pokémon, quality-of-life upgrades, Kanto achievements, and the FAFF0x quest/story layer.

**Red Earth v1.0.5 removes Gen1 Modern UI, Modern UI Fix, and Wilds of Kanto.** Gen1 Modern UI was retired upstream and caused misaligned touch/options input on iOS; Wilds of Kanto was removed while isolating the encounter-field crash.
