...
**Red Earth v1.0.7 removes Gen1 Modern UI, Modern UI Fix, and Wilds of Kanto.** Gen1 Modern UI caused misaligned touch/options input on iOS; Wilds of Kanto was removed while isolating the encounter-field crash.
...
The v1.0.7 cart contains 35 pinned mods.
